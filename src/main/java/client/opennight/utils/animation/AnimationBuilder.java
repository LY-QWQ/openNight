package client.opennight.utils.animation;

import java.util.LinkedList;
import java.util.Optional;
import client.opennight.utils.animation.AnimationTimer;
import client.opennight.utils.animation.NamedAnimationTimer;
