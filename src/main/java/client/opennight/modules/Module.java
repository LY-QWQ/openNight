package client.opennight.modules;
...
import client.opennight.event.impl.ModuleToggleEvent;
import client.opennight.hud.ModuleListHud;
import client.opennight.modules.Category;
import client.opennight.modules.KeyBind;
...
extends ClientBase {
    ...
    public void setEnabled(boolean enabled) {
        ...
        NightClient.getInstance().getEventBus().call(new ModuleToggleEvent(this, enabled));
    }
