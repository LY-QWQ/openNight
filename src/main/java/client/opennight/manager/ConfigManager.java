...
import client.opennight.config.Config;
import client.opennight.config.ModulesConfig;
import client.opennight.config.ValuesConfig;

public class ConfigManager {
    public static final Logger LOGGER = LogManager.getLogger("ConfigManager");
    public static final File CONFIG_DIR = new File(NightClient.configDir, "configs");
