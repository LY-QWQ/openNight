...
import client.opennight.event.impl.RenderEntityEvent;
import client.opennight.event.impl.RotationAnimationEvent;
import client.opennight.modules.impl.render.FakeAntiAim;
...
public class LivingEntityRendererPatch {
    ...
    public static void onRenderPost(
        ...
        NightClient.getInstance().getEventBus().call(post);
    }
