...
public class NeverloseWatermark {
    ...
    public void onRender2D(Render2DEvent render2DEvent) {
        ...
        float nameWidth = this.measureText(NightClient.CLIENT_NAME_UPPER, this.boldFont);
    ...
    public void onGlRender(GlRenderEvent glRenderEvent) {
        ...
        float gap = 6.0f;
        float cornerRadius = 4.5f;
        currentX = this.renderSection(glRenderEvent.drawContext(), currentX, y, NightClient.CLIENT_NAME_UPPER, this.boldFont, cornerRadius, gap);
    ...
    private float getTotalWidth() {
        float total = 0.0f;
        float gap = 6.0f;
        total += this.measureText(NightClient.CLIENT_NAME_UPPER, this.boldFont) + gap;
