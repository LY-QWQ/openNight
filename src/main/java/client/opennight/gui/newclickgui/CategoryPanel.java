...
import client.opennight.gui.newclickgui.ModuleElement;
...
import client.opennight.render.StencilHelper;
...
extends UIElement {
    ...
    public CategoryPanel(Category category) {
        ...
        for (Module module : NightClient.getInstance().getModuleManager().getModulesByCategory(category)) {
